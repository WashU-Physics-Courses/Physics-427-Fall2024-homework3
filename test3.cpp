...
int main() {
  ...
  std::cout << "Testing Gauss Quadrature with 10 points using relative tolerance of " << eps << std::endl;
  ...
  if (std::abs(result2 - I2) < eps * std::abs(I2)) {
  ...
  if (std::abs(result3 - I3) < eps * std::abs(I3)) {
